    ...
    <>
      ...
      >
        ...
        <nav className="flex flex-col gap-2 p-6">
          <Link href="/" className="py-2 px-4 rounded text-lg text-white hover:bg-[#00ffe7] hover:text-[#181818] transition-colors duration-300" onClick={() => setSidebarOpen(false)}>Home</Link>
